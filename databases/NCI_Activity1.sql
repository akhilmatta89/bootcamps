...
#
#The script can be executed from the MySQL Workbench as demonstrated in class.
#
...
INSERT INTO Branch VALUES (
"B7","16 Argyll St",NULL,"Aberdeen","AB2 3SU","0131-4561010","0245-8777912"
);
CREATE TABLE Staff(
...
INSERT INTO Staff VALUES (
"SG14","David","Ford","63 Ashby St,Glasgow","0141-3392177","Supervisor","M","1958-03-24",18000,"WL220658D","B3"
);
...
INSERT INTO Property_For_Rent VALUES (
"PG04","6 Lawrence St","Partick","Glasgow","G11 9QX","Flat",3,350,"CO40","SG14","B3"
);
INSERT INTO Property_For_Rent VALUES (
...
INSERT INTO Viewing Values(
"CR76","PG04","1995-04-20","Too Remote"
);
INSERT INTO Viewing Values(
"CR56","PG04","1995-05-26",NULL
);
INSERT INTO Viewing Values(
...
-- Task 1: List the properties for Rent and state how many
select * from property_for_rent;
select count(*) as "Total count of properties" from property_for_rent;

-- Task 2: List the Branches and state how many
select Bno, count(Bno) from branch group by Bno;

-- Task 3: List all information about the Staff
select * from staff;

-- Task 4: List the Staff working at branch no. B5
select * from staff where Bno="B5";

-- Task 5: List the Staff working at branch no. B5 and B3
select * from staff where Bno="B5" or Bno="B3";

-- Task 6: List the Staff No, the names, addresses and Telephone Numbers for all staff members
select Sno, Concat(Fname," ",Lname), Address, TelNo from staff;

-- Task 7: Produce the following:
-- Sno	Name			Position
-- SL21	John White		Manager
-- SG5	Susan Brand		Manager
select Sno, Concat(Fname," ",Lname), Position from staff;

-- Task 8: List each Staff No, Staff name (first and surname), tel no & branch no in ascending order of name
select Sno, Concat(Fname," ",Lname) as fullName, TelNo, Bno from staff ORDER BY fullName ASC;

-- Task 9: Show the staff number of the person that is responsible for property PA14
select Sno from property_for_rent where Pno="PA14";

-- Task 10: Find Owners that live in Aberdeen
select CONCAT(Fname,"",Lname) as full_name, Address from owner where Address Like "%Aberdeen%";

-- Task 11: Find Owners whose first names begin with the letter ‘C’
select CONCAT(Fname," ",Lname) as full_name from owner where Fname Like "c%";

-- Task 12: Show the following for all properties:
-- 	i)	Pno,
-- 	ii)	Street,
-- 	iii) Rooms,
-- 	iv)	Rent,
...
-- Task 13: Then for property no. PG4
select Pno, Street, Rooms, Rent, Ono, Sno from property_for_rent where Pno="PG04";

-- Task 14: Then for owner no CO46
select Pno, Street, Rooms, Rent, Ono, Sno from property_for_rent where Ono="CO46";

-- Task 15: For properties that the rent is greater than 400
select * from property_for_rent where rent>400;

-- Task 16: For properties that the rent is between 355 and 470
select * from property_for_rent where rent between 355 and 470;